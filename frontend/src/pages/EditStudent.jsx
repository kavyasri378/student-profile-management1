    ...
    try {
      ...
      setFormData({
        personalInfo: {
          ...
          dateOfBirth: new Date(profile.personalInfo.dateOfBirth).toISOString().split('T')[0],
          gender: profile.personalInfo.gender,
          phone: profile.personalInfo.phone,
          address: profile.personalInfo.address
        },
        academicDetails: {
          studentId: profile.academicDetails.studentId,
          course: profile.academicDetails.course,
          department: profile.academicDetails.department,
          year: profile.academicDetails.year.toString(),
          semester: profile.academicDetails.semester.toString(),
          enrollmentDate: new Date(profile.academicDetails.enrollmentDate).toISOString().split('T')[0],
          gpa: profile.academicDetails.gpa || ''
        },
        feeDetails: {
          totalFees: profile.feeDetails.totalFees.toString(),
          feesPaid: profile.feeDetails.feesPaid.toString()
        }
      });
    } catch (error) {
